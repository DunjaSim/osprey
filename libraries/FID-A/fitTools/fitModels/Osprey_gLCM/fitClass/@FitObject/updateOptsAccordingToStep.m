...
%% Update parameters
    ...
    if ~isfield(options, 'parametrizations')
        for ff = 1 : length(options.parameter) 
            pars = char(options.parameter(ff));
            switch pars     
                case 'ph0'
                ...
                case 'GlobFreqShift'
                    % Initialize global frequency shifts as constant with value 0 Hz
                    options.parametrizations.GlobFreqShift.fun     = 'free';
                    options.parametrizations.GlobFreqShift.gradfun = 'free';
                    options.parametrizations.GlobFreqShift.lb      = -10;
                    options.parametrizations.GlobFreqShift.ub      = 10;
                    options.parametrizations.GlobFreqShift.init    = 0;
                    options.parametrizations.GlobFreqShift.ex      = 0;
                    options.parametrizations.GlobFreqShift.sd      = Inf;
                    options.parametrizations.GlobFreqShift.RegFun  = '';
                ...
                case 'x'
                    ...
                    options.parametrizations.x.RegFun    = '';
