...
function [out,fs]=op_alignAverages_ShiftOnly(in,tmax,med,ref)
    ...
    for m=1:B
        ...
        for n=1:in.sz(in.dims.averages)
            if n~=ind_min
                ...
                parsFit=nlinfit(in.fids(in.t>=0 & in.t<tmax,n,m),base,@op_freqPhaseShiftComplexNest,parsGuess,opts);
